...
\begin{frame}{Field Profit Analysis}
  \begin{figure}
    \begin{block}{}
      \begin{itemize}
        ...
        \item Maximum threshold size of \textbf{Container} = 2 x Cache Line Size is verified at runtime.
        \item If the container size of \textbf{Container} exceeds the threshold,
...
\begin{frame}{Selective Inlining}
  \begin{figure}
    \begin{block}{}
      \begin{columns}[c] 
        \column{.42\textwidth} % Left column and width
    ...
    \lstinputlisting[style=code]{code/Container_X.java}
    \end{figure}
        \column{.57\textwidth} % Right column and width
        \begin{itemize}
